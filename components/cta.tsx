    ...
    <section id="cta" className="py-20 px-6">
      <div className="container mx-auto max-w-4xl">
        <div className="bg-gradient-to-r from-primary to-primary-foreground rounded-lg shadow-2xl p-8 md:p-12 text-white">
          ...
          <p className="text-xl mb-8 opacity-90">Join Nexverse and be part of the next evolution in technology .From intelligent AI agents to powerful apps, websites, and automation systems, we help you turn bold ideas into reality. Empower your business with innovation that defines tomorrow.
		  </p>
